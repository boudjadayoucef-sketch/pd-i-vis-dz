...
function migrateProjectFileV474(value:unknown, fallbackOwnerUid = ""):IsoProjectFileV474 {
  ...
  const fallbackLine:PipingLine={id:DEFAULT_LINE_ID,lineNumber:'8" Constantine',service:"Gaz naturel",dn:200,nps:'8"',material:"Acier API 5L Gr. B",pressureClass:"Class 600",schedule:"40",designPressure:40,color:"#9CA3AF"};
...
function IsometrieModule() {
  ...
  const [lines,setLinesRaw]=useState<PipingLine[]>([{id:DEFAULT_LINE_ID,lineNumber:'8" Constantine',service:"Gaz naturel",dn:200,nps:'8"',material:"Acier API 5L Gr. B",pressureClass:"Class 600",schedule:"40",designPressure:40,color:"#9CA3AF"}]);
