...
export default function PdiUnifiedApp() {
  ...
  useEffect(() => {
    const onNavigate = (event: Event) => {
      const detail = (event as CustomEvent<PdiModule | "landing" | string>).detail as PdiModule | "landing";
      ...
      <main className="pdi-content">
        {activeModule === "home" && <div className="pdi-home-hero">
          <section className="pdi-hero-card">
            ...
            <button className="pdi-start-primary" onClick={() => openModuleInTab("isometric", "Nouveau plan ISO")}>Nouveau projet isométrique</button>
